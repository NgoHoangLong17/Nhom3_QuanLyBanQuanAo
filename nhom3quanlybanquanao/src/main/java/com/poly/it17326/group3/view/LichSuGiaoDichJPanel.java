...
public void loadData(List<HoaDonChiTiet> list ){
    ...
    private void TblLichsuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TblLichsuMouseClicked
        ...
        TxtNV.setText(TblLichsu.getValueAt(row, 0).toString());
        txtNgayTao.setText(TblLichsu.getValueAt(row, 2).toString());
        txtKhuyenMai.setText(TblLichsu.getValueAt(row, 5).toString());
        txtThanhTien.setText(TblLichsu.getValueAt(row, 6).toString());
    }//GEN-LAST:event_TblLichsuMouseClicked

    private void TblhoadonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TblhoadonMouseClicked
        // TODO add your handling code here:
        int row = Tblhoadon.getSelectedRow();
        TxtKH.setText(Tblhoadon.getValueAt(row, 1).toString());
        jTextField13.setText(Tblhoadon.getValueAt(row, 4).toString());
